...
//Calculate max zoom
zoom = 2;
zoom_max = floor(display_get_width() / 480);
/*
if (display_get_width() >= 3840) zoom_max = 8;
else if (display_get_width() >= 3360) zoom_max = 7;
else if (display_get_width() >= 2880) zoom_max = 6;
else if (display_get_width() >= 2400) zoom_max = 5;
else if (display_get_width() >= 1920) zoom_max = 4;
else if (display_get_width() >= 1440) zoom_max = 3;
else zoom_max = 2;
*/
